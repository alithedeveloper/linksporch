<template>
    <svg viewBox="0 0 64 64" :class="classes" class="fill-current">
        ...
        <path d="M32 38.24a2 2 0 01-1.414-3.414l24-24a2 2 0 112.828 2.828l-24 24c-.39.39-.902.586-1.414.586z"/>
        <path d="M32 38.24a1.99 1.99 0 01-1.414-.586l-8.485-8.485a2 2 0 112.828-2.828l8.485 8.485A2 2 0 0132 38.24z"/>
    </svg>
</template>
